...
int main() {
    ...
    // 2. Initialize Pipeline with native .aeon format (2 layers: Layer 0 and Layer 1)
    aeon::core::V4Pipeline pipeline;
    pipeline.init_aeon(aeon_model_dir, 2, 8, 256);

    // 3. Test Step 1: Execute single token step
    std::cout << "\n[Step 1] Running single-token forward step on native .aeon model (token=1, pos=0)..." << std::endl;
    ...
    std::cout << "\n[Step 2] Testing multi-token autoregressive generation from native .aeon weights..." << std::endl;
    ...
    std::cout << "\n[Step 3] Verifying Tier 1 VRAM LRU Cache Statistics on .aeon model..." << std::endl;
    ...
    std::cout << "\n================================================================================" << std::endl;
    std::cout << "  [SUCCESS] Native .aeon Model Pipeline & Inference Validated on Physical Silicon!" << std::endl;
    std::cout << "================================================================================" << std::endl;
    return 0;
}
