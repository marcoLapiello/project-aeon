...
| Default `ctest` | 43 infrastructure/backend/text/kept-component/Tier-1/Tier-2/Tier-3/Tier-4/Step-3/item-23/P1/P2 tests |
| Legacy `ctest` | 45 — the 43 plus exactly the two gated real-weight parity anchors |
