...
| Default `ctest` | 35 infrastructure/backend/text/kept-component/Tier-1/Tier-2/Tier-3 tests |
| Legacy `ctest` | 37 (the 35 plus the 2 gated parity anchors) |
...
such; neither is a correctness gap. What remains of the plan's sequence is Tier 4 — **item 21**
(streaming/tiering: expert bytes bit-exact across Hot/Warm/Cold), **item 22** (prefix cache
