...
- [x] V4 pipeline ownership reduction: model-level allocations moved to `V4ModelResources`, and Hot/Warm/Cold transfer, prefetch, direct-I/O materialization, and supply telemetry state moved to `V4ExpertSupplyCoordinator` without changing full-model behavior.
